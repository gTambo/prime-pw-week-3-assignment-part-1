...
let favFoods = ['tacos', 'pizza', 'bacon', 'nanamash', 'braised beef', 'sandwiches'];
...
let oopsFood = favFoods.pop();
console.log('Just kidding about the ', oopsFood);
console.log('My favorite foods are still: ', favFoods);
...
favFoods.unshift('Cherries');
console.log(`Added another more favorite food: ${favFoods}`);
...
//     log both the food removed and the updated array
let noThanks = favFoods.shift();
console.log('Removed this food: ', noThanks);
